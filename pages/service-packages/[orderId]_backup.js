                            ...
                            <div className="row">
                                <div className="col-md-7">
                                    ...
                                    <div className='formbx-white add-address' style={{ display: selectAddressTab === false ? "none" : "block" }}>
                                        ...
                                        <div className='option-address' style={{ display: addressRadioAndAddTab === false ? "none" : "block" }}>
                                            <ul className='selectaddress'>
                                                ...
                                                {
                                                    fetchAddresses !== undefined && fetchAddresses !== '' && fetchAddresses.data !== undefined && fetchAddresses.data !== undefined && fetchAddresses.data.address !== '' && fetchAddresses.data.address !== undefined && fetchAddresses.data.address.map((addr, i) => {
                                    ...
                                    <div className='formbx-white add-time-date' style={{ display: vehicleInspactionDateTab === false ? "none" : "block" }}>
                                        <h3 style={{ display: selectionInspactionDateTime === false ? "none" : "block" }}>Select Vehicle Inspection Date</h3>
                                ...
                                <div className="col-md-5">
                                    <div className="nextstep">
                                        <div className='formbx-white p-0  mobile-view-hide'>
                                            ...
                                            <div className='vehicle-list-detail'>
                                                <ul>
                                                    <li>Year<span>{order.order_car_registration_year !== '' && order.order_car_registration_year !== undefined ? order.order_car_registration_year : ''}</span></li>
