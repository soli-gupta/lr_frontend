...
function FinalServiceDetails() {
    ...
    const { data, error } = useSWR(`${Url}user/edit-user-car-care?id=${orderId}`, loggedFetcher);
    ...
    const submitServiceCenterAddress = async (e) => {
        ...
        setTinyLoader(true);
        await axios.post(`${Url}user/update-user-car-care/${orderId}`, getServiceCenterData, {
            headers: {
                token: localStorage.getItem('lr-user-token')
            }
        }).then((res) => {
    ...
    const submitSelectedAddress = async (e) => {
        ...
        await axios.post(`${Url}user/update-user-car-care/${orderId}`, getUserAddressData, {
            headers: {
                token: localStorage.getItem('lr-user-token')
            }
        }).then((res) => {
    ...
    const submitSelectedDate = async (e) => {
        ...
        await axios.post(`${Url}user/update-user-car-care/${orderId}`, getSelectedDateTimeData, {
            headers: {
                token: localStorage.getItem('lr-user-token')
            }
        }).then((res) => {
    ...
    const savePickUpCarDetail = async (e) => {
        ...
        await axios.post(`${process.env.NEXT_PUBLIC_URL}user/update-user-car-care/${orderId}`, formData, {
            headers: {
                'Content-Type': 'application/json',
                'token': typeof window !== "undefined" ? localStorage.getItem("lr-user-token") : false,
            }
    ...
    const savePickUpPersonDetail = async (e) => {
        ...
        const formData = { ...{ 'pickup_person_name': pickupPersonFirstName + ' ' + pickupPersonLastName, 'pickup_person_mobile': pickupPersonMobile }, ...form_step }
        setTinyLoader(true);
        await axios.post(`${process.env.NEXT_PUBLIC_URL}user/update-user-car-care/${orderId}`, formData, {
            headers: {
                'Content-Type': 'application/json',
    ...
    const submitCarCarePayment = async () => {
        setTinyLoader(true);
        await axios.post(`${process.env.NEXT_PUBLIC_URL}user/update-user-car-care/${orderId}`, { 'step_form': 6 }, {
            headers: {
                'Content-Type': 'application/json',
                'token': typeof window !== "undefined" ? localStorage.getItem("lr-user-token") : false,
            }
            ...
            .then(function (res) {
                if (res.data.status == 1) {
                    setTinyLoader(false);
                    router.push(`/car-care/thank-you?id=${orderId}`)
                }
            })
            .catch(function (e) {
                setTinyLoader(false)
                        ...
                        <div className="row">
                            <div className="col-md-7">
                                <div className='formbx-white p-0 desktop-hide-div border-mobile mobile-show-div'>
                                    ...
                                    <div className='vehicle-list-detail'>
                                        <ul>
                                            ...
                                            <li>Color<span>{order.color !== undefined ? order.color : ''}</span></li>
                                        </ul>
                                ...
                                <div className='formbx-white add-time-date' style={{ display: order.step_form >= 2 ? "block" : dateTimeTab === false ? "none" : "block" }} >
                                    <h3 style={{ display: order.step_form === 2 ? "block" : vehicleInspactionDateTab == false ? "none" : "block" }}>Select Date For Car Care</h3>
                                            ...
                                            <div className='row'>
                                                <div className='col-md-6'>
                                                    <div className='form-input'>
                                                        ...
                                                        <input type='text' id="pickup_person_first_name" name="pickup_person_first_name" placeholder='Enter your first name' onChange={(e) => setPickupPersonFirstName(e.target.value)} defaultValue={pickupPersonFirstName} />
                                                ...
                                                <div className='col-md-6'>
                                                    <div className='form-input'>
                                                        ...
                                                        <input type='text' id="pickup_person_last_name" name="pickup_person_last_name" placeholder='Enter your last name' onChange={(e) => setPickupPersonLastName(e.target.value)} defaultValue={pickupPersonLastName} />
                                                ...
                                                <div className='col-md-6'>
                                                    <div className='form-input'>
                                                        ...
                                                        <input type='text' placeholder='Enter your mobile number*' name="pickup_person_mobile" onChange={(e) => setPickupMobile(e.target.value)} maxLength={10} defaultValue={pickupPersonMobile} />
                                ...
                                {/* <div className='formbx-white payment button-payment' style={{ display: order.step_form >= 5 ? "block" : paymentsTab == false ? "none" : "block" }}>
                                    <h3>Payments</h3>
                                    <div className='nextstep' style={{ display: order.step_form >= 5 ? "block" : paymentsTab == false ? "none" : "block" }}>
                                        <button className='btn blueBdr' onClick={submitCarCarePayment}><span>Pay At Workhop</span></button>
                                        <button className='btn arrow-style green-btn'><span>Pay Now & Get INR 1500/- Off</span></button>
                                    </div>
