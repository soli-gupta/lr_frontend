...
import CarCareComponent from '@/components/dashboard/CarCareComponent';
...
function Index() {
	...
	const { data, error } = useSWR(`${process.env.NEXT_PUBLIC_URL}user/user-car-care-list`, fetcher);
		...
		<>
			...
			<div className='user-dashboard'>
				...
				<div className='user-mob-back mobile-style'>
					...
					<Link className='back-link' href="user-menu">Car Care</Link>
					...
					<div className='user-bgBox'>
						...
						<div className='user-right test-drive-user sell-req service'>
							...
							<div className='formbx-white p-0 user-style'>
								...
								<div className="border-heading"><h3>Car Care</h3></div>
								...
								{data !== undefined && data.data.length > 0 ?
									...
									<>
										...
										<div className='after-car-added'>
											<div className='white-inner'>
												<CarCareComponent data={data && data.data} />
											</div>
									...
									<div className='no-data-added'>
										...
										<h6>You Have Not Booked Any Car Care Services Yet</h6>

										<Link className='btn arrow-style blue-btn' href='/car-care'><span>View Car Care</span></Link>
