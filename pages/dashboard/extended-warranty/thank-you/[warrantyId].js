...
function ThankYouExtendedWarranty() {

    const Url = process.env.NEXT_PUBLIC_URL;
    const router = useRouter();
    const { warrantyId } = router.query;
    ...
    const { data, error } = useSWR(`${Url}user/fetch-order-details/${warrantyId}`, loggedFetcher);
    ...
    const uploadDocsForCarInspaction = async (e) => {
        ...
        await axios.patch(`${Url}upload-doc-after-order/${warrantyId}`, formData, {
            headers: {
                token: localStorage.getItem("lr-user-token")
            }
        }).then((res) => {
                            ...
                            <div className="col-md-7">
                                ...
                                <div className='formbx-white congratulation-bx' style={{ display: "block" }}>
                                    ...
                                    <div className='payment-orderinfo'>
                                        ...
                                        <span>Your order ID is {data !== undefined && data.order !== undefined ? data.order.order_id : ''}</span>
                                    </div>
                                    ...
                                    <div className='address-confirmation'>
                                        <ul>
                                            {/* <li>
                                                ...
                                                You would have got an SMS with all the details of your extended warranty
                                            </li> */}
                                            <li>
                                                <div className='icon-add'>
                                            ...
                                            <li>
                                                ...
                                                <span>Car Inspection Address</span>
                                ...
                                <form method="POST" onSubmit={uploadDocsForCarInspaction} id="car-inspaction-upload-docs" encType='multipart/form-data'>
                                    ...
                                    <div className='formbx-white'>
                                        ...
                                        <div className='form-input mg-0'>
                                            <button className='btn arrow-style blue-btn'><span>Submit</span></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
export default ThankYouExtendedWarranty;
