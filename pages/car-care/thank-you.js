...
export default function CareOwnerInfo() {
    ...
    const fetchData = async () => {
        await axios.get(`${process.env.NEXT_PUBLIC_URL}user/edit-user-car-care?id=${id}`, {
            headers: {
                        ...
                        <div className="row">
                            <div className="col-md-7">
                                <div className='formbx-white p-0 desktop-hide-div border-mobile mobile-show-div'>
                                    ...
                                    <div className='vehicle-list-detail'>
                                        {userCarInfo && userCarInfo !== undefined && <ul>
                                            ...
                                            <li>Color<span>{userCarInfo.color ? userCarInfo.color : ''}</span></li>
                                        </ul>
                                        }
                                    </div>
                                </div>
                                <div className='formbx-white congratulation-bx'>
                                    ...
                                    <div className='payment-orderinfo'>
                                        ...
                                        Your car care
                                        <span className='blue-txt'> confirmation Order ID is {userCarInfo && userCarInfo.order_id ? userCarInfo.order_id : ''}</span>
                                    </div>
                            ...
                            <div className="col-md-5">
                                <div className="nextstep">
                                    ...
                                    {/* <div className='order-cancle'>Cancel anytime, fully refundable. <a href="" className='btnunderline'>Learn more</a></div> */}
                                </div>
