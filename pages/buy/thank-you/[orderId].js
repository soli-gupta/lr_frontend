                        ...
                        <div className='row'>
                                ...
                                <div className='formbx-white congratulation-bx' style={{ display: "block" }}>
                                    <div className='congo-namebx'>
                                        ...
                                        <div className='msg-congo'>
                                            <h2>Congratulations! {data.order.user_first_name ? data.order.user_first_name : ''} {data.order.user_last_name ? data.order.user_last_name : ''}</h2>
                                            <ul>
                                                <li>+91-{data.order.user_contact ? data.order.user_contact : ''}</li>
                                    ...
                                    <div className='payment-orderinfo'>
                                        <p>  We have received your payment of <span className="payment-orderinfo-span"> INR {numberFormatter(data.order.user_booking_amount)}</span>.
                                            <br /> Your order ID is <span className="payment-orderinfo-span">{data.order.order_id ? data.order.order_id : ''}</span>.</p>
                                    </div>
                                    <div className='address-confirmation'>
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <span>{data.order.user_address_type ? data.order.user_address_type : ''}</span>
                                                {data.order.user_full_address ? data.order.user_full_address : ''}
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div className='sticky-div'>
                                    <div className='formbx-white p-0 order-summary overflow-unset'>
                                        ...
                                        <div className='vehicle-list-detail border-bottom pad-small '>
                                            <ul>
                                                <li>Brand<span>{data.order.order_brand_name ? data.order.order_brand_name : ''}</span></li>
                                                <li>Reg. Year<span>{data.order.order_car_registration_year ? data.order.order_car_registration_year : ''}</span></li>
                                                <li>Model<span>{data.order.order_model_name ? data.order.order_model_name : ''}</span></li>
                                                <li>Variant<span>{data.order.order_variant_name ? data.order.order_variant_name : ''}</span></li>
                                                <li>Ownership<span>{data.order.order_car_ownership ? data.order.order_car_ownership : ''}</span></li>
                                                <li>KMs Driven<span>{data.order.order_car_kms ? numberFormatter(data.order.order_car_kms) : ''}</span></li>
                                            </ul >
                                        </div >
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <div className='right-txt'>
                                                        {data.order.order_car_insurance_type === "Valid" ? ` ${data.order.order_car_insurance_type} Till ${data.order.order_car_insurance_valid}` : (data.order.order_car_insurance_type === "Expired" || data.order.order_car_insurance_valid === "expired" ? `Expired in  ${data.order.order_car_insurance_valid}` : '')} */}
                            {/* // Jan 2024 */}
                            {/* </div>
                                                </li>
                                                <li>
                            ...
                            {/* </div>
                                                    <div className='right-txt blue-txt-order'>
                                                        ...
                                                        <b>INR {data.order.user_booking_amount ? numberFormatter(data.order.user_booking_amount) : ''}/-</b>
                                                    </div>
                                                </li> */}
                            {/*    <li>
                            ...
                            {/* <li className='grandtotal'>
                                                    <div className='left-txt'>Balance Amount</div>
