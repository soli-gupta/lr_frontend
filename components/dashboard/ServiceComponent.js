...
export default function Index(carCare) {
    ...
    const cancelEvaluation = async (e) => {
        ...
        await axios.post(`${process.env.NEXT_PUBLIC_URL}user/cancel-service-request`, formData, {
            headers: {
    ...
    return (
        <>
                ...
                {data !== undefined && data.length > 0 && data ? data.map((carcare, i) => {
                    return (
                        <>
                            ...
                            <div className={`list ${carcare.step_form !== 7 ? 'pending' : carcare.status === 2 ? 'completed' : carcare.status === 3 ? 'cancelled' : ''}`} key={i}>
                                ...
                                <div className='grey-bg'>
                                    <div className="prductSec01">
                                        <div className='flag'>{carcare.step_form !== 7 ? 'Pending' : carcare.status === 1 ? 'Upcoming' : carcare.status === 2 ? 'Completed' : carcare.status === 3 ? 'Cancelled' : carcare.status === 4 ? 'On-going' : ''} </div>
                                        <div className="row">
                                            ...
                                            <div className="car-div-dashboard for-mobile actions mobile-style">
                                                {carcare.step_form !== 7 && <Link href={`/dashboard/service/${carcare._id}`} className='btn mobile-style reverse'>Complete Your Form</Link>}
                                            </div>
                                        </div>
                                    </div>
                                    {/* Service Detail */}
                                    <div className='car-user-info two-colum align-top gap-b'>
                                        ...
                                        <div className='car-div-dashboard no-border'>
                                            ...
                                            {carcare.status === 3 ?
                                                <>
                                                    <h3 className='assigned'>Service Appointment Cancelled</h3>
                                                    <p><span>Reason:</span> Getting better offer</p>
                                                </>
                                                : <div className='view-detail blue-border-style'></div>}
                                    ...
                                    <div className='car-user-info two-colum tab-full top-border-gap'>
                                        ...
                                        <div className='car-div-dashboard no-block new-two-btn actions'>
                                            <div>
                                                {carcare.status === 1 ?
                                                    <>
                                                        ...
                                                        <div className='btn single-btn-full reverse'>Book Another Service</div>
                                                    </> : ''}

                                                {carcare.step_form !== 7 && <Link href={`/dashboard/service/${carcare._id}`} className='btn desktop-style single-btn-full  reverse'>Complete Your Form</Link>}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div style={{ display: "block" }
                        ...
                        <div className='popup-inner'>
                            ...
                            <div className='before-otp'>
                                ...
                                <h3>Cancel Service Appointment</h3>
                                    ...
                                    <div className='from-row border-style'>
                                        ...
                                        <div className='form-div'>
                                            ...
                                            <div className='radio-div'>
                                                <input id='better' type="radio" name="cancel_reason" defaultValue="Looking for OEM service centres only" onClick={() => openDescriptionDiv()} />
                                                <label htmlFor="better">
                                                    Looking for OEM service centres only
                                            ...
                                            <div className='radio-div'>
                                                <input id='station' type="radio" name="cancel_reason" defaultValue="Don’t live in Delhi NCR" onClick={() => openDescriptionDiv()} />
                                            ...
                                            <div className='radio-div'>
                                                <input id='accident' type="radio" name="cancel_reason" defaultValue="The car issue is fixed" onClick={() => openDescriptionDiv()} />
                                                <label htmlFor="accident">
                                                    The car issue is fixed

                                                </label>
                                            </div>

                                            <div className='radio-div'>
                                                <input id='sold' type="radio" name="cancel_reason" defaultValue="Sent to other service provider" onClick={() => openDescriptionDiv()} />
                                                <label htmlFor="sold">
                                                    Sent to other service provider
            ...
            {
                ReSchedule ?
                    <ReScheduleService closePop={closePop} carCareId={carCareId} data={rescheduleData} />
                    : ""
            }
