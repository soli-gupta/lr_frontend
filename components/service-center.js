...
import { dateConverterForValue, numberFormatter, weekDatesForForms } from './Helper';
...
function ServiceCenters({ user, leadType }) {
    ...
    const { data, error } = useSWR(`${Url}fetch-service-centers`, fetcher);
            ...
            <section className="custom-servicebx commonm-gap">
                <div className="wrapper">
                    <div className="center-text">
                        <h2>Explore Our Service Centres</h2>
                        <p>Schedule your maintenances, repairs and other services easily with a Luxury Ride Service Centres near you.</p>
                    </div>
                    {/* 
                                    ...
                                    <div className='col-lg-4 col-md-6' key={center._id}>
                                        <div className='service-centerdiv'>
                                            <div className='img-servicecenter'>
                                                <img src={`${Url}${center.service_center_banner}`} alt="" />
                                            </div>
                                            <div className='txt-service-details'>
                                                <ul>
                                                    {center.center_area !== '' && center.center_area !== undefined ? <li><span>{numberFormatter(center.center_area)}</span>Sq. Ft. Area</li> : ''}
                                                    {center.center_car_bay !== undefined && center.center_car_bay !== '' ? <li><span>{center.center_car_bay}</span>Parallel Bay</li> : ''}
                                                    {center.center_daily_service !== undefined && center.center_daily_service !== '' ? <li><span>{center.center_daily_service}</span>Serviced Daily</li> : ''}
                                                </ul>
                                                <h2>{center.name} Service Centre</h2>
                            ...
                            <div className='style-box'>
                                ...
                                <div className="from-row">
                                    ...
                                    <div className='form-div'>
                                        ...
                                        <input type="text" placeholder='Enter Name' name="visitor_first_name" onChange={handleCenterBookVisitFirstName} defaultValue={user !== undefined && user !== '' ? user.first_name : firstNameInput} id="visiter-name" />
