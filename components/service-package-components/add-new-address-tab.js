...
function AddNewAddressTab({ addNewAddressTab, saveNewAddress, checkPinCode, getStates, manageCities, getCities, getCitiesByState, managePinCodeHandler, popUp, successMessage, errorMessage, closePopUp }) {
...
export default AddNewAddressTab;